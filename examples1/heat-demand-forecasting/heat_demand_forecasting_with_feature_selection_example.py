...
data['year'] = data.index.get_level_values(0).year.astype('category')
data['month'] = data.index.get_level_values(0).month.astype('category')
data['hour'] = data.index.get_level_values(0).hour.astype('category')


# Import parameters
params_path = 'parameters_fs.json'
...
# The selected features are saved in the parameter file in the results folder